...
ActiveRecord::Schema.define(version: 2023_03_17_035327) do
  ...
  create_table "subscriptions", force: :cascade do |t|
    ...
    t.index ["sender_id"], name: "index_subscriptions_on_sender_id"
  end
  ...
  add_foreign_key "subscriptions", "users", column: "recipient_id"
